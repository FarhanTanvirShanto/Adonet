...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    <div class="row">
        <div class="col-12">
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="OrderManagement.App_Code.Category" DeleteMethod="Delete" InsertMethod="Insert" SelectMethod="Get" TypeName="OrderManagement.App_Code.CategoryRepo" UpdateMethod="Update" SelectCountMethod="CategoryCount" OldValuesParameterFormatString="original_{0}"></asp:ObjectDataSource>
                </ContentTemplate>
            </asp:UpdatePanel>
